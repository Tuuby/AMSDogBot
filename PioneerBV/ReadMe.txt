========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : PioneerBV
========================================================================


Diese PioneerBV-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre PioneerBV-Anwendung bilden.
...
PioneerBV.h
	...
	Anwendungsklasse CPioneerBVApp.
...
res\PioneerBV.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei PioneerBV.rc eingebunden.
...
PioneerBVDlg.h, PioneerBVDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CPioneerBVDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in PioneerBV.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	PioneerBV.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
